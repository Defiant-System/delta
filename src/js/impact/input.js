...
Impact.Input = Impact.Class.extend({
	bindings: {},
	actions: {},
	presses: {},
	locks: {},
	...
	initMouse: function() {
		...
		Impact.system.canvas.addEventListener('contextmenu', this.contextmenu.bind(this), false );
		Impact.system.canvas.addEventListener('mousedown', this.keydown.bind(this), false );
		...
		if (Impact.ua.touchDevice ) {
			...
			Impact.system.canvas.addEventListener('touchcancel', this.keyup.bind(this), false );
			Impact.system.canvas.addEventListener('touchmove', this.mousemove.bind(this), false );
			
			// MS
			Impact.system.canvas.addEventListener('MSPointerDown', this.keydown.bind(this), false );
			Impact.system.canvas.addEventListener('MSPointerUp', this.keyup.bind(this), false );
			Impact.system.canvas.addEventListener('MSPointerMove', this.mousemove.bind(this), false );
			Impact.system.canvas.style.msTouchAction = 'none';
		}
	},
	...
	mousemove: function( event ) {		
		var internalWidth = Impact.system.canvas.offsetWidth || Impact.system.realWidth;

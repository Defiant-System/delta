...
Impact.Game = Impact.Class.extend({
	...
	namedEntities: {},
	collisionMap: Impact.CollisionMap.staticNoCollision,
	backgroundMaps: [],
	backgroundAnims: {},
	...
	staticInstantiate: function() {
		this.sortBy = this.sortBy || Impact.Game.SORT.Z_INDEX;
		Impact.game = this;
		return null;
	},
	...
	loadLevel: function( data ) {
		...
		// Map Layer
		this.collisionMap = Impact.CollisionMap.staticNoCollision;
		this.backgroundMaps = [];
		for( var i = 0; i < data.layer.length; i++ ) {
			...
			if (ld.name == 'collision' ) {
				...
				var newMap = new Impact.BackgroundMap(ld.tilesize, ld.data, ld.tilesetName);
	...
	removeEntity: function( ent ) {
		...
		// updated or checked
		ent._killed = true;
		ent.type = Impact.Entity.TYPE.NONE;
	...
	draw: function(){
		...
		this._rscreen.x = Impact.system.getDrawPos(this.screen.x)/Impact.system.scale;
		this._rscreen.y = Impact.system.getDrawPos(this.screen.y)/Impact.system.scale;
	...
	checkEntities: function() {
		...
		for( var e = 0; e < this.entities.length; e++ ) {
			...
			if(
				entity.type == Impact.Entity.TYPE.NONE &&
				entity.checkAgainst == Impact.Entity.TYPE.NONE &&
				entity.collides == Impact.Entity.COLLIDES.NEVER
			) {
				continue;
			}
